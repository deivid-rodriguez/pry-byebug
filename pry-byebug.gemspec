...
Gem::Specification.new do |gem|
  ...
  gem.license       = 'MIT'
  gem.homepage      = 'https://github.com/nixme/pry-byebug'
  gem.summary       = 'Fast debugging with Pry.'
  gem.description   = "Combine 'pry' with 'byebug'. Adds 'step', 'next', and 'continue' commands to control execution."
  ...
  gem.add_runtime_dependency 'byebug', '1.1.0'
