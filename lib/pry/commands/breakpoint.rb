...
class Pry
  class Command::Break < ByebugCommand
    match 'break'
    group 'Byebug'
  ...
  class Command::BreakPoints < ByebugCommand
    match 'breakpoints'
    group 'Byebug'
  ...
  Pry::Commands.helpers do
  end

  Pry::Commands.add_command(Pry::Command::Break)
  Pry::Commands.alias_command 'breakpoint', 'break'
  Pry::Commands.add_command(Pry::Command::BreakPoints)
